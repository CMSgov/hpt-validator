...
export class CsvValidationRule {
  // public static normalizedColumns: (string | undefined)[] = [];
  // public static enteredColumns: (string | undefined)[] = [];
...
export const bigListOfRules = [descriptionRequired, settingRequired];

// export function giveMeAllTheRules(version, normalizedColumns, dataColumns) {
//   return []
// }

// weeeee different thigns
